...
def setup_db():
    ...
    sale3 = Sale.create('SALE', bound_rand_date(cust4.join_date), 4, 2, 43, 6_000, 'Active')
    sale4 = Sale.create('SALE', bound_rand_date(cust5.join_date), 5, 3, 6, 19_000, 'Closed')
    sale5 = Sale.create('SALE', bound_rand_date(cust7.join_date), 7, 4, 12, 16_000, 'Active')
    sale6 = Sale.create('SALE', bound_rand_date(cust1.join_date), 1, 4, 11, 69_000, 'Active')
    sale7 = Sale.create('SALE', bound_rand_date(cust2.join_date), 2, 1, 24, 9_000, 'Closed')
    sale8 = Sale.create('SALE', bound_rand_date(cust4.join_date), 4, 3, 42, 6_000, 'Active')
    sale9 = Sale.create('SALE', bound_rand_date(cust5.join_date), 8, 2, 16, 19_000, 'Closed')
    sale10 = Sale.create('SALE', bound_rand_date(cust7.join_date), 10, 2, 22, 16_000, 'Active')
    sale11 = Sale.create('SALE', bound_rand_date(cust1.join_date), 1, 1, 14, 69_000, 'Active')
    ...
    td1 = Testdrive.create('TESTDRIVE', bound_rand_date(sm1.hire_date), 1, 1, random.randint(1, 50), "The guy drove thru a McDonalds and ordered a 50-pc chicken nugget.")
    td2 = Testdrive.create('TESTDRIVE', bound_rand_date(sm1.hire_date), 3, 1, random.randint(1, 50), "Dude crashed into lightpole then tried to bribe me with an expired Chuck E Cheese coupon.")
    td3 = Testdrive.create('TESTDRIVE', bound_rand_date(sm1.hire_date), 3, 1, random.randint(1, 50), "The customer kept telling me about her toenail collection.")
    td4 = Testdrive.create('TESTDRIVE', bound_rand_date(sm1.hire_date), 1, 1, random.randint(1, 50), "Person did not show up.")
    td5 = Testdrive.create('TESTDRIVE', bound_rand_date(sm2.hire_date), 4, 2, random.randint(1, 50), "Testdrive actually went well.")
    td6 = Testdrive.create('TESTDRIVE', bound_rand_date(sm3.hire_date), 7, 3, random.randint(1, 50), "The guy drove thru a McDonalds and ordered a 50-pc chicken nugget.")
    td7 = Testdrive.create('TESTDRIVE', bound_rand_date(sm4.hire_date), 6, 4, random.randint(1, 50), "Dude crashed into lightpole then tried to bribe me with an expired Chuck E Cheese coupon.")
    td8 = Testdrive.create('TESTDRIVE', bound_rand_date(sm4.hire_date), 7, 4, random.randint(1, 50), "The customer kept telling me about her toenail collection.")
    td9 = Testdrive.create('TESTDRIVE', bound_rand_date(sm1.hire_date), 1, 1, random.randint(1, 50), "Person did not show up.")
    td10 = Testdrive.create('TESTDRIVE', bound_rand_date(sm1.hire_date), 1, 1, random.randint(1, 50), "Testdrive actually went well.")
    td11 = Testdrive.create('TESTDRIVE', bound_rand_date(sm3.hire_date), 7, 3, random.randint(1, 50), "The guy drove thru a McDonalds and ordered a 50-pc chicken nugget.")
    td12 = Testdrive.create('TESTDRIVE', bound_rand_date(sm2.hire_date), 7, 2, random.randint(1, 50), "Dude crashed into lightpole then tried to bribe me with an expired Chuck E Cheese coupon.")
    td13 = Testdrive.create('TESTDRIVE', bound_rand_date(sm3.hire_date), 8, 3, random.randint(1, 50), "The customer kept telling me about her toenail collection.")
    td14 = Testdrive.create('TESTDRIVE', bound_rand_date(sm3.hire_date), 10, 3, random.randint(1, 50), "Person did not show up.")
    td15 = Testdrive.create('TESTDRIVE', bound_rand_date(sm2.hire_date), 9, 2, random.randint(1, 50), "Testdrive actually went well.")
