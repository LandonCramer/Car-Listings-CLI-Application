...
def setup_db():
    ...
    # td1 = Testdrive.create('TESTDRIVE', bound_rand_date(st1.hire_date), 1, 1, 1, "The guy drove thru a McDonalds and ordered a 50-pc chicken nugget.")
    # td2 = Testdrive.create('TESTDRIVE', bound_rand_date(st1.hire_date), 1, 1, 1, "Dude crashed into lightpole then tried to bribe me with an expired Chuck E Cheese coupon.")
    # td3 = Testdrive.create('TESTDRIVE', bound_rand_date(st1.hire_date), 1, 1, 1, "The customer kept telling me about her toenail collection.")
    # td4 = Testdrive.create('TESTDRIVE', bound_rand_date(st1.hire_date), 1, 1, 1, "Person did not show up.")
    # td5 = Testdrive.create('TESTDRIVE', bound_rand_date(st1.hire_date), 1, 1, 1, "Testdrive actually went well.")
    # td6 = Testdrive.create('TESTDRIVE', bound_rand_date(st1.hire_date), 1, 1, 1, "The guy drove thru a McDonalds and ordered a 50-pc chicken nugget.")
    # td7 = Testdrive.create('TESTDRIVE', bound_rand_date(st1.hire_date), 1, 1, 1, "Dude crashed into lightpole then tried to bribe me with an expired Chuck E Cheese coupon.")
    # td8 = Testdrive.create('TESTDRIVE', bound_rand_date(st1.hire_date), 1, 1, 1, "The customer kept telling me about her toenail collection.")
    # td9 = Testdrive.create('TESTDRIVE', bound_rand_date(st1.hire_date), 1, 1, 1, "Person did not show up.")
    # td10 = Testdrive.create('TESTDRIVE', bound_rand_date(st1.hire_date), 1, 1, 1, "Testdrive actually went well.")
    # td11 = Testdrive.create('TESTDRIVE', bound_rand_date(st1.hire_date), 1, 1, 1, "The guy drove thru a McDonalds and ordered a 50-pc chicken nugget.")
    # td12 = Testdrive.create('TESTDRIVE', bound_rand_date(st1.hire_date), 1, 1, 1, "Dude crashed into lightpole then tried to bribe me with an expired Chuck E Cheese coupon.")
    # td13 = Testdrive.create('TESTDRIVE', bound_rand_date(st1.hire_date), 1, 1, 1, "The customer kept telling me about her toenail collection.")
    # td14 = Testdrive.create('TESTDRIVE', bound_rand_date(st1.hire_date), 1, 1, 1, "Person did not show up.")
    # td15 = Testdrive.create('TESTDRIVE', bound_rand_date(st1.hire_date), 1, 1, 1, "Testdrive actually went well.")
